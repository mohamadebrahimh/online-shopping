...
namespace Businessdevweb.Controllers
{
    ...
    public partial class AccountController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            return View(UserManager.Users.FirstOrDefault(m => m.Id ==userid));
        }
        ...
        public ActionResult Edit([Bind(Include = "FirstName,LastName,PhoneNumber")] ApplicationUser model)
        {

            var userid = User.Identity.GetUserId();
            var user = UserManager.Users.FirstOrDefault(m => m.Id == userid);
        ...
        public virtual async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "تلاش برای ورود نا معتبر است");
                    return View(model);
            }
        }
        ...
        public virtual async Task<ActionResult> VerifyCode(VerifyCodeViewModel model)
        {
            ...
            switch (result)
            {
                ...
                case SignInStatus.Failure:
                default:
                    ModelState.AddModelError("", "کد وارد شده نامعتبر است.");
                    return View(model);
            }
        }
