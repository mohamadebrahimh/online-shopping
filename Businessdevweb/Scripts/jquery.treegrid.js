...
(function($) {
    ...
    var methods = {
        ...
        initExpander: function() {
            var $this = $(this);
            var cell = $this.find('span').get($this.treegrid('getSetting', 'treeColumn'));
            ...
            $(tpl).prependTo(cell).click(function() {
                $($(this).closest('li')).treegrid('toggle');
            });
            return $this;
        },
        /**
            ...
            return $(this).each(function() {
                ...
                if (expander) {
                    ...
                    if (!$this.treegrid('isCollapsed')) {
                        ...
                        expander.addClass($this.treegrid('getSetting', 'expanderExpandedClass')).text($this.treegrid('getSetting', 'textExpanded'));
                    } else {
                        expander.removeClass($this.treegrid('getSetting', 'expanderExpandedClass'));
                        expander.addClass($this.treegrid('getSetting', 'expanderCollapsedClass')).text($this.treegrid('getSetting', 'textCollapsed'));
                    }
                } else {
    ...
    $.fn.treegrid.defaults = {
        ...
        getNodeById: function(id, treegridContainer) {
            ...
            return treegridContainer.find('li.' + templateClass);
        },
        ...
        getRootNodes: function(treegridContainer) {
            var result = $.grep(treegridContainer.find('li'), function(element) {
