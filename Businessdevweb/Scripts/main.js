...
$(document).ready(function($) {
  ...
  (function() {
    var docElem = document.documentElement,
      didScroll = false,
      changeHeaderOn = 100;
    document.querySelector('section>section.introduction');
    ...
    function scrollPage() {
      ...
      if (sy >= changeHeaderOn) {
          ...
          $(".mdl-layout>.mdl-layout__header").removeClass("visuallyhidden").addClass("mdl-layout--fixed-header");
        ...
        //};
          ...
          $(".mdl-layout>.mdl-layout__header").removeClass("mdl-layout--fixed-header").addClass("visuallyhidden");
        //if (/iPhone|iPod|BlackBerry/i.test(navigator.userAgent) || $(window).width() < 479) {
        //  $('.navbar-default .navbar-nav > li > a').css({
        //    'padding-top': 15 + "px",
